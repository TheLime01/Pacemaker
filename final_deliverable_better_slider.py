...
def Successful_login(): #Gives access to my account page
    ...
    save_button = Button(root, text="Save Parameters", command=save_parameters) #save button
    save_button.place(x=600, y=500)

    print_button = Button(root, text="Print Parameters", command=print_parameters) #print button
    print_button.place(x=600, y=550)
...
def combo_box_create(): #function to make dropdown menu
    ...
    global combo_box 
    combo_box = ttk.Combobox(root, values = Modes, state = 'readonly') #fills combo box with mode, and user can read only 
...
def initializes_sliders(): #initializes all the sliders
    ...
    sliders["Lower Rate Limit"] = create_slider_with_entry(root, "Lower Rate Limit", 30, 180, 800, 10, 60)
    sliders["Upper Rate Limit"] = create_slider_with_entry(root, "Upper Rate Limit", 50, 200, 800, 90, 120)
    sliders["Atrial Amplitude"] = create_slider_with_entry(root, "Atrial Amplitude", 0.5, 5.0, 800, 170, 3.5)
    sliders["Atrial Pules Width"] = create_slider_with_entry(root, "Atrial Pules Width", 0.05, 1.9, 800, 260, 0.4)
    sliders["Ventricular Amplitude"] = create_slider_with_entry(root, "Ventricular Amplitude", 0.5, 5.0, 800, 340, 3.5)
    sliders["Ventricular Pulse Width"] = create_slider_with_entry(root, "Ventricular Pulse Width", 0.05, 1.9, 800, 420, 0.4)
    sliders["VRP"] = create_slider_with_entry(root, "VRP", 150, 500, 800, 500, 320)
    sliders["ARP"] = create_slider_with_entry(root, "ARP", 150, 500, 800, 580, 250)
